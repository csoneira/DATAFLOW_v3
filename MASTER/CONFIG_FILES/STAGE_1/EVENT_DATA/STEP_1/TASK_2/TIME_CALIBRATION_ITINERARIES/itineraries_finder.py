...
Purpose: Utilities to generate and persist time-calibration itineraries.
...
STEP_1_CONFIG_PATH = (
    CONFIG_DIR / "STAGE_1" / "EVENT_DATA" / "STEP_1" / "TASK_2" / "config_task_2.yaml"
)
...
HOME_PATH = _load_home_path(STEP_1_CONFIG_PATH)
