...
Script: MASTER/STAGES/STAGE_1/EVENT_DATA/STEP_2/corrected_to_accumulated.py
Purpose: !/usr/bin/env python3.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MASTER/STAGES/STAGE_1/EVENT_DATA/STEP_2/corrected_to_accumulated.py [options]
