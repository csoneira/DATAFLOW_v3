#!/usr/bin/env bash
# Truncate cron log files under EXECUTION_LOGS/CRON_LOGS.
set -euo pipefail
...
Keeps only the most recent N lines in cron logs under EXECUTION_LOGS/CRON_LOGS.
Targets include:
...
LOG_DIR="${CRON_LOG_DIR:-/home/mingo/DATAFLOW_v3/EXECUTION_LOGS/CRON_LOGS}"
