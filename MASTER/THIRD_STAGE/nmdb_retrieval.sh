...
# 0 2 * * * /bin/bash /home/cayetano/DATAFLOW_v3/MASTER/THIRD_STAGE/nmdb_retrieval.sh >> /home/cayetano/DATAFLOW_v3/MASTER/THIRD_STAGE/update_log.txt 2>&1

# ==== CONFIGURATION ====
BASE_DIR="/home/cayetano/DATAFLOW_v3/MASTER/THIRD_STAGE"
