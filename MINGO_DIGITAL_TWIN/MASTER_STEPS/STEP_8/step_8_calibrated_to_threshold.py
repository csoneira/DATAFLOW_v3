#!/usr/bin/env python3
"""Step 8: apply front-end thresholding and charge-to-time conversion.

Inputs: geom_<G>_calibrated from Step 7.
Outputs: geom_<G>_threshold.(pkl|csv) with thresholded channels.
"""
