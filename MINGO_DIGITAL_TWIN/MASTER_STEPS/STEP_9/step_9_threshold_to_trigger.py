...
def main() -> None:
    ...
    if args.plot_only:
        if args.no_plots:
            ...
            return
        for out_file in sorted(output_dir.rglob(f"SIM_RUN_*/geom_*_triggered.{output_format}")):
        ...
        for manifest_path in sorted(output_dir.rglob("SIM_RUN_*/geom_*_triggered.chunks.json")):
