...
Script: MINGO_DIGITAL_TWIN/MASTER_STEPS/STEP_3/step_3_crossing_to_hit.py
Purpose: Step 3: apply efficiencies and avalanche model to crossings.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/MASTER_STEPS/STEP_3/step_3_crossing_to_hit.py [options]
