...
Script: MINGO_DIGITAL_TWIN/MASTER_STEPS/STEP_SHARED/sim_utils_io.py
Purpose: Filesystem and dataframe I/O helpers for simulation steps.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/MASTER_STEPS/STEP_SHARED/sim_utils_io.py [options]
