...
- STEP_10: DAQ Jitter
  ...
  - Output: INTERSTEPS/STEP_10_TO_11/SIM_RUN_<N>/geom_<G>_daq.(pkl|csv)
  - Key fields: daq_jitter_ns, jittered T_front/T_back

- STEP_11: DAQ -> Detector Text
  - Script: MASTER_STEPS/STEP_11/step_11_daq_to_detector_format.py
  - Output: INTERSTEPS/STEP_11_TO_12/SIM_RUN_<N>/mi00YYDDDHHMMSS.dat
  - Key fields: detector text format (date/time, event_type, per-strip T/Q)

- STEP_12: Detector Text -> Station Dat
  - Script: MASTER_STEPS/STEP_12/step_12_detector_to_station_dat.py
