...
Script: MINGO_DIGITAL_TWIN/VALIDATION/validators/validate_step6_endpoints.py
Purpose: Validator for STEP 6 front/back endpoint construction.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/VALIDATION/validators/validate_step6_endpoints.py [options]
