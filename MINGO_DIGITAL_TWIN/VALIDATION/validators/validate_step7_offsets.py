...
Script: MINGO_DIGITAL_TWIN/VALIDATION/validators/validate_step7_offsets.py
Purpose: Validator for STEP 7 cable/offset application.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/VALIDATION/validators/validate_step7_offsets.py [options]
