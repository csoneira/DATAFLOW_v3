...
Script: MINGO_DIGITAL_TWIN/VALIDATION/validators/validate_step0_mesh.py
Purpose: Validator for STEP 0 parameter mesh.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/VALIDATION/validators/validate_step0_mesh.py [options]
