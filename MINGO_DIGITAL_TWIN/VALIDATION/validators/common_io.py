...
Script: MINGO_DIGITAL_TWIN/VALIDATION/validators/common_io.py
Purpose: Read-only I/O helpers for validation workflows.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/VALIDATION/validators/common_io.py [options]
