...
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/ORCHESTRATOR/maintenance/sanitize_sim_runs.py [options]
...
def main() -> None:
    ...
    parser.add_argument(
        "--step-final-lock",
        default="~/DATAFLOW_v3/OPERATIONS/OPERATIONS_RUNTIME/LOCKS/cron/sim_final.lock",
        help=(
