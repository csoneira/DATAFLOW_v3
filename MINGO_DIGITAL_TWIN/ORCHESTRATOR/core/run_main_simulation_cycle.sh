...
SIM_ENQUEUE_LOCK="${ROOT_DIR}/OPERATIONS/OPERATIONS_RUNTIME/LOCKS/cron/sim_enqueue.lock"
SIM_PROCESSING_LOCK="${ROOT_DIR}/OPERATIONS/OPERATIONS_RUNTIME/LOCKS/cron/sim_processing.lock"
SIM_FINAL_LOCK="${ROOT_DIR}/OPERATIONS/OPERATIONS_RUNTIME/LOCKS/cron/sim_final.lock"
...
DEFAULT_LAST_RUN_STATE_FILE="${ROOT_DIR}/OPERATIONS/OPERATIONS_RUNTIME/LOCKS/cron/sim_main_pipeline.last_run_epoch"
