...
Script: MINGO_DIGITAL_TWIN/PLOTTERS/STEPS/STEP_6/plot_step_6.py
Purpose: Plots for STEP 6 — adapted from MASTER_STEPS/STEP_6/step_6_triggered_to_timing.py.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/PLOTTERS/STEPS/STEP_6/plot_step_6.py [options]
...
def plot_frontback_summary(df: pd.DataFrame, output_path: Path) -> None:
    with PdfPages(output_path) as pdf:
        ...
        plot_frontback_asymmetry_diagnostics(df, pdf, stage_label="STEP 6")
