...
Script: MINGO_DIGITAL_TWIN/PLOTTERS/EXECUTION/MESH/tests/test_parse_efficiencies.py
Purpose: Test parse efficiencies.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_DIGITAL_TWIN/PLOTTERS/EXECUTION/MESH/tests/test_parse_efficiencies.py [options]
