...
| --- | --- | --- | --- |
| WP1 | Real `.hld/.dat` or simulated `.dat` inputs | Corrected/enriched station outputs in `MINGO_ANALYSIS/MINGO_ANALYSIS_STATIONS/` | Stage checks complete, no unresolved ingest/correction failures |
