...
# Script: OPERATIONS/OPERATIONS_SCRIPTS/ORCHESTRATION/KILL_RUNNING_PROCESSES/kill_pipeline_execution_processes.sh
# Purpose: Kill running bash/python scripts referenced in CONFIG/add_to_crontab.info without touching unrelated processes.
# Owner: DATAFLOW_v3 contributors
# Sign-off: csoneira <csoneira@ucm.es>
# Last Updated: 2026-03-02
# Runtime: bash
# Usage: bash OPERATIONS/OPERATIONS_SCRIPTS/ORCHESTRATION/KILL_RUNNING_PROCESSES/kill_pipeline_execution_processes.sh [options]
