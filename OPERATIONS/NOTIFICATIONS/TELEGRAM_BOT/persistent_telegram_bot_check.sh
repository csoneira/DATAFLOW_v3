...
BOT_SCRIPT="${BOT_SCRIPT:-/home/mingo/DATAFLOW_v3/OPERATIONS/NOTIFICATIONS/TELEGRAM_BOT/mingo_analysis_bot.py}"
LOG_DIR="${LOG_DIR:-/home/mingo/DATAFLOW_v3/OPERATIONS_RUNTIME/CRON_LOGS}"
