...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/selection_config.py
Purpose: Shared parsing for station/date selection config with master overrides.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/selection_config.py [options]
