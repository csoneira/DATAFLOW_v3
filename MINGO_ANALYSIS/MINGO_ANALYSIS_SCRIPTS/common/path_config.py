...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/path_config.py
Purpose: Path config.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/path_config.py [options]
...
def _discover_repo_root() -> Path:
    # MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/path_config.py -> DATAFLOW_v3
...
def load_repo_paths(config_path: str | Path | None = None) -> RepoPaths:
    ...
    return RepoPaths(
        ...
        operations_runtime_root=repo_root / "OPERATIONS" / "OPERATIONS_RUNTIME",
    )
