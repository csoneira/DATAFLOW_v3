...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/file_selection.py
Purpose: Utilities for selecting the newest DATAFLOW artifacts by basename.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/file_selection.py [options]
