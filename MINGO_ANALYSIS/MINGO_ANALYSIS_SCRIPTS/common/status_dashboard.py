...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/status_dashboard.py
Purpose: Utilities for aggregating status CSV logs and serving them for dashboards.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/status_dashboard.py [options]
...
DEFAULT_OUTPUT = REPO_ROOT / "MINGO_ANALYSIS" / "MINGO_ANALYSIS_SCRIPTS" / "common" / "status_dashboard" / "status_timeseries.csv"
