...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/execution_logger.py
Purpose: Utility helpers for recording execution timing information to a shared CSV log.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/common/execution_logger.py [options]
...
LOG_PATH = pathlib.Path(os.path.expanduser("~/DATAFLOW_v3/MINGO_ANALYSIS/MINGO_ANALYSIS_STATIONS/python_execution_log.csv"))
