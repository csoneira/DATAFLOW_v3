...
def _station_root(total_root: Path, station_name: str) -> Path:
    return total_root / "MINGO_ANALYSIS" / "MINGO_ANALYSIS_STATIONS" / station_name
...
def _collect_overwritten_metadata_reports(
    ...
    *,
    ...
    for step in enabled_steps:
        ...
        for report_path in sorted(step_dir.glob(f"TASK_*/MINGO_ANALYSIS/MINGO_ANALYSIS_STATIONS/*/OUTPUTS/FILES/{OVERWRITTEN_METADATA_RE}")):
