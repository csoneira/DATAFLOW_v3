...
# Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/run_timtrack_quality_scan.sh
# Purpose: Periodically scan TimTrack convergence settings and refresh plots.
# Owner: DATAFLOW_v3 contributors
# Sign-off: csoneira <csoneira@ucm.es>
# Last Updated: 2026-03-05
# Runtime: bash
# Usage: bash MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/run_timtrack_quality_scan.sh [options]
...
Options:
  --config <path>            Path to scan config file.
                             Default: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/CONFIGS/timtrack_quality_scan.conf
...
plot_output_dir="${plot_output_dir:-MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/OUTPUT}"
scan_log_csv="${scan_log_csv:-MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/OUTPUT/timtrack_quality_scan_log.csv}"
run_reference_csv="${run_reference_csv:-MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/OUTPUT/timtrack_quality_scan_run_reference.csv}"
plot_run_back="${plot_run_back:-0}"
task4_script="${task4_script:-MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_1/EVENT_DATA/STEP_1/TASK_4/script_4_list_to_fit.py}"
task4_parameters_csv="${task4_parameters_csv:-MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/CONFIG_FILES/STAGE_1/EVENT_DATA/STEP_1/TASK_4/config_parameters_task_4.csv}"
...
if [[ -z "${task4_specific_metadata_csv}" ]]; then
  TASK4_SPECIFIC_CSV_ABS="${REPO_ROOT}/MINGO_ANALYSIS/MINGO_ANALYSIS_STATIONS/${station_label}/STAGE_1/EVENT_DATA/STEP_1/TASK_4/METADATA/task_4_metadata_specific.csv"
else
  TASK4_SPECIFIC_CSV_ABS="$(resolve_path "${task4_specific_metadata_csv}")"
fi
if [[ -z "${task4_profiling_metadata_csv}" ]]; then
  TASK4_PROFILING_CSV_ABS="${REPO_ROOT}/MINGO_ANALYSIS/MINGO_ANALYSIS_STATIONS/${station_label}/STAGE_1/EVENT_DATA/STEP_1/TASK_4/METADATA/task_4_metadata_profiling.csv"
else
