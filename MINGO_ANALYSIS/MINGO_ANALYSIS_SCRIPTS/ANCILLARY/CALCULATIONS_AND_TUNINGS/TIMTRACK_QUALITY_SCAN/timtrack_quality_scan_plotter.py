...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/timtrack_quality_scan_plotter.py
Purpose: Plot Task 4 metadata during TimTrack convergence scans.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-05
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/timtrack_quality_scan_plotter.py [options]
