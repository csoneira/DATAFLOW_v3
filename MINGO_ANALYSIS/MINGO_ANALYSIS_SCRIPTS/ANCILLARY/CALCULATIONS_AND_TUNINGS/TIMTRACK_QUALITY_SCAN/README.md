...
MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/run_timtrack_quality_scan.sh --plot-only

# Run one cycle (first enabled profile), then exit
MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/run_timtrack_quality_scan.sh --once
```

## Continuous scan

```bash
MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/run_timtrack_quality_scan.sh
```
...
```bash
MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/ANCILLARY/TIMTRACK_QUALITY_SCAN/run_timtrack_quality_scan.sh --run-task4
```
