...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_2/build_stage_2_dataset.py
Purpose: Join Stage 1 event, lab-log, and Copernicus outputs into a final Stage 2 dataset.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_2/build_stage_2_dataset.py [options]
...
from MINGO_ANALYSIS.MINGO_ANALYSIS_SCRIPTS.common.path_config import get_master_config_root, resolve_home_path_from_config
...
from MINGO_ANALYSIS.MINGO_ANALYSIS_SCRIPTS.STAGES.STAGE_2.plot_joined_stage_groups import generate_joined_groups_plot
...
def main() -> int:
    ...
    station_dir = base_path / "DATAFLOW_v3" / "MINGO_ANALYSIS" / "MINGO_ANALYSIS_STATIONS" / f"MINGO0{station_id}"
