...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_2/plot_joined_stage_groups.py
Purpose: Plot grouped time-series panels for joined Stage 2 or Stage 3 station tables.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-03
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_2/plot_joined_stage_groups.py --input-csv PATH --output PATH --config PATH
...
from MINGO_ANALYSIS.MINGO_ANALYSIS_SCRIPTS.common.selection_config import EventMarkerConfig, load_master_event_markers, parse_station_id
