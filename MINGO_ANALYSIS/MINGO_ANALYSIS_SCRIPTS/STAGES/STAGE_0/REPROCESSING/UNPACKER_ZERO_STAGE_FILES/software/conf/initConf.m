...
% Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_0/REPROCESSING/UNPACKER_ZERO_STAGE_FILES/software/conf/initConf.m
...
if strcmp(result, 'manta')
    ...
    SYSTEMNAME  = env_system;
    % Software location
    HOME        = [getenv('HOME') '/DATAFLOW_v3/MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_0/REPROCESSING/UNPACKER_ZERO_STAGE_FILES/']; # <--------------------------------------------
    % System data structure
    SYS         = [HOME 'system/'];
    INTERPRETER = 'octave';
end
