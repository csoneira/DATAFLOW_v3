...
Script: MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_1/COPERNICUS/STEP_1/copernicus_bring.py
Purpose: !/usr/bin/env python3.
Owner: DATAFLOW_v3 contributors
Sign-off: csoneira <csoneira@ucm.es>
Last Updated: 2026-03-02
Runtime: python3
Usage: python3 MINGO_ANALYSIS/MINGO_ANALYSIS_SCRIPTS/STAGES/STAGE_1/COPERNICUS/STEP_1/copernicus_bring.py [options]
...
from MINGO_ANALYSIS.MINGO_ANALYSIS_SCRIPTS.common.status_csv import append_status_row, mark_status_complete
...
def main() -> int:
    ...
    station_dir = home_path / "DATAFLOW_v3" / "MINGO_ANALYSIS" / "MINGO_ANALYSIS_STATIONS" / f"MINGO0{station}"
