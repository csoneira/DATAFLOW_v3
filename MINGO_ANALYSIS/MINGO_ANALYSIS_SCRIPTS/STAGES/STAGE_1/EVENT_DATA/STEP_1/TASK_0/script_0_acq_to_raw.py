...
station_directory = repo_root / "MINGO_ANALYSIS" / "MINGO_ANALYSIS_STATIONS" / f"MINGO0{station}"
...
_, simulated_param_hash = resolve_simulated_z_positions(
    basename_no_ext,
    repo_root / "MINGO_ANALYSIS" / "MINGO_ANALYSIS_STATIONS" / f"MINGO0{station}" / "STAGE_1" / "EVENT_DATA",
