...
- Input all-samples results: `STEP_4_SELF_CONSISTENCY/output/l2/all_samples_results.csv`
- Input LUT directory: `STEP_6_UNCERTAINTY_LUT/output/l2/lut`
...
Representative points with estimates and uncertainty intervals are in: `STEP_7_SIMULATED_DEMO/output/l2/demo_points_with_uncertainty.csv`
